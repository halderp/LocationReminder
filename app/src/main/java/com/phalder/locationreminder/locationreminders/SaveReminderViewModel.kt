...
import com.phalder.locationreminder.base.BaseViewModel
...
class SaveReminderViewModel(val app: Application, val dataSource: ReminderDataSource) :
    ...
    fun validateEnteredData(reminderData: ReminderDataItem): Boolean {
        ...
        // Validation fails because the location is null or empty need.
    ...
    fun setSelectedLocation(placeOfInterest: PointOfInterest) {
        selectedPOI.postValue(placeOfInterest)
    }
}